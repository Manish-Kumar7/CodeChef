...
Chef has 3 boxes of sizes A, B, and C respectively. He puts the boxes in bags of size D (A≤B≤C≤D
...
Test case 1
: The sum of sizes of boxes is 2+3+5=10

which is equal to the size of a bag. Hence Chef can put all three boxes in a single bag.

Test case 2
: Chef can put boxes of size 1 and 3 in one bag and box of size 2

in another bag.

Test case 3
: Chef puts all the boxes in separate bags as there is no way to put more than one box in a single bag.
*/
#include <iostream>
using namespace std;
